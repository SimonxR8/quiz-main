            ...
            <form action="check_addquestion.php" method="post">
                ...
                while ($row = mysqli_fetch_assoc($result)) { ?>
                    <tr>
                        ...
                        <td><a href="./editequestion/editequestion.php?id=<?php echo $row['id']?>" name="edit" class="edit">แก้ไข<i class="far fa-edit fontawesome"></a></td>
                        <td><button type="submit" name="delete" class="remove" onclick="return confirm('คุณต้องการลบหรือไม่');">ลบ<i class="fa-regular fa-trash-can  fontawesome"></button></td>
                    </tr>
                <?php } ?>
        </table>
