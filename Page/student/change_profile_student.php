...
<body>
    ...
    <section class="main">
        ...
        <div class="dashboard">
            ...
            <form action="update_change_profile_student.php" method="post">
            <div class="main-profile">
                ...
                <div hidden>
                    ...
                    <input type="number" name="student-id" value="<?php echo $row['member_code'] ?>" >
                </div>
            ...
            <div class="dashboard-bottom">
                ...
                <a href="student_page.php" class="btn button-style-change-private">
                    ยกเลิก
                </a>
            </div>
            </form>
