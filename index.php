                    ...
                    <div class="dashboard">
                        <h1 style="text-align: center;">ข้อมูลส่วนตัว</h1>
                            <br>
                                <div class='data' style="display: flex; justify-content: center;">
                                    <img class='image' src='<?php if($row['img_url'] == '') echo 'images/img_avatar.png'; else echo 'uploads/'.$row['img_url'];?>' width='167px' height='166px'>
                                </div>
                        <div class="main-profile">
                            ...
                            <div class="dashboard-bottom">
                                        <a href="index.php" class="btn button-style-change-profile ">
                                        <i class='bx bx-edit style-icon-CPF'></i>
                                            เปลี่ยนรูปโปรไฟล์</button>
                                        </a>
                                        <a href="index.php" class="btn button-style-change-private">
